                            ...
                            <footer className={classes.footerSection}>
                                <div className={classes.footerContent}>
                                    <div className={classes.footerLinks}>
                                        <Anchor
                                            href={getConfig('VITE_TOS_URL', 'https://evenday.app/politica-de-privacidade') as string}
                                        ...
                                        <Anchor
                                            href={getConfig('VITE_PRIVACY_URL', 'https://evenday.app/termos-de-servico') as string}
                                            className={classes.footerLink}
                                        >
                                            {t`Terms of Service`}
                                        </Anchor>
